...
if not ACCESS_TOKEN:
    print("Warning: ACCESS_TOKEN environment variable not found. GitHub GraphQL API requests require a Personal Access Token.")
HEADERS = {'authorization': 'token ' + ACCESS_TOKEN}
USER_NAME = os.environ.get('USER_NAME', 'PippyUrkel')
